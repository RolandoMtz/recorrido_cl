...
RSpec.describe "/contracts", type: :request do
  ...
  Service.create(codigo: "001", nombre: "Monitoreo Recorrido.cl").save

  let(:valid_attributes) {
    {service_id: 1, dia: 0, hora_inicio: "19:00"}
  }

  let(:invalid_attributes) {
    {service_id: nil, dia: 0, hora_inicio: "19:00"}
  }
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      let(:new_attributes) {
        {service_id: 1, dia: 1, hora_inicio: "19:00"}
      }
